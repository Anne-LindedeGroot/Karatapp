...
import '../../desktop/desktop_platform_utils.dart';
import '../../core/navigation/app_router.dart';
import 'avatar_selection_screen.dart';
import 'data_usage_settings_screen.dart';
part 'profile_screen_helpers.dart';
...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
            ...
            child: Column(
              ...
              children: [
                ...
                if (currentUser?.email != null) ...[
                  Builder(
                    builder: (context) {
                      final showSingleLineEmail =
                          DesktopPlatformUtils.isDesktopPlatform() ||
                          context.screenSize == ScreenSize.desktop ||
                          context.screenSize == ScreenSize.largeDesktop;
                      final email = currentUser!.email!;
                      if (showSingleLineEmail) {
  ...
  // Helper methods moved to profile_screen_helpers.dart
}
