        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            EnhancedAccessibleTextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: IconButton(
                  tooltip: _isLoginPasswordVisible ? 'Verberg wachtwoord' : 'Toon wachtwoord',
                  icon: Icon(
                  ...
                  onPressed: () {
                    ...
                    _speakIfEnabled(
                      _isLoginPasswordVisible ? 'Wachtwoord tonen' : 'Wachtwoord verbergen',
                    );
                  },
                ),
              ),
            ...
            Align(
              ...
              child: TextButton(
                onPressed: () {
                  _speakIfEnabled('Wachtwoord vergeten knop');
                  _goToPasswordReset();
                },
          ...
          child: Column(
            ...
            EnhancedAccessibleTextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: IconButton(
                  tooltip: _isSignupPasswordVisible ? 'Verberg wachtwoord' : 'Toon wachtwoord',
                  icon: Icon(
                    _isSignupPasswordVisible ? Icons.visibility_off : Icons.visibility,
                  ),
                  onPressed: () {
                    setState(() {
                    ...
                    _speakIfEnabled(
                      _isSignupPasswordVisible ? 'Wachtwoord tonen' : 'Wachtwoord verbergen',
                    );
                  },
                ),
              ),
            ...
            EnhancedAccessibleTextField(
              ...
              decoration: InputDecoration(
                ...
                border: const OutlineInputBorder(),
                suffixIcon: IconButton(
                  tooltip: _isSignupConfirmPasswordVisible ? 'Verberg wachtwoord' : 'Toon wachtwoord',
                  icon: Icon(
                    _isSignupConfirmPasswordVisible ? Icons.visibility_off : Icons.visibility,
                  ),
                  onPressed: () {
                    setState(() {
                    ...
                    _speakIfEnabled(
                      _isSignupConfirmPasswordVisible ? 'Wachtwoord tonen' : 'Wachtwoord verbergen',
                    );
                  },
                ),
              ),
